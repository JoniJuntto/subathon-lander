...
export default function CompanySocials(){
  ...
  <div className="flex justify-evenly items-center py-4">
   <div className="hover:bg-[#007EBB] w-16 h-16 rounded-full flex items-center justify-center cursor-pointer">
      <img src={linkedin} alt="linkedin" className="w-12 mx-2" />
    </div>
                 <div className="hover:bg-[#367796] w-16 h-16 rounded-full flex items-center justify-center cursor-pointer">
    <svg

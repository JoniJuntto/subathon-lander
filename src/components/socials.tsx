...
export default function Socials() {
        return (
            ...
            <div className="flex justify-around my-4">
              ...
              <div
                className="border hover:bg-gray-400 w-12 h-12 fill-[#1d9bf0] hover:fill-white border-gray-400 rounded-full flex items-center justify-center shadow-xl hover:shadow-gray-400/50 cursor-pointer"
              >
